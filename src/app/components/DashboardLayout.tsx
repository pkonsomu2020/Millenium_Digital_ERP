  ...
  return (
    <div className="flex h-screen bg-white dark:bg-[#1F2937] overflow-hidden">
      ...
      <main className="flex-1 overflow-auto bg-gray-50 dark:bg-[#111827] w-full flex flex-col">
        ...
        <div className="lg:hidden sticky top-0 z-30 bg-[#374151] text-white px-3 py-2.5 flex items-center gap-2 shadow-md safe-area-top">
          <button
        ...
        {/* Global Topbar — desktop only; phones/tablets use the compact app bar above */}
        <div className="hidden lg:block shrink-0 px-8 pt-6 pb-0">
          <div className="bg-[#374151] text-white rounded-xl p-3 sm:p-4 lg:p-6 shadow-lg flex flex-row items-center justify-between gap-3">
            <div className="min-w-0 flex-1">
              <h1 className="text-lg sm:text-2xl lg:text-3xl font-bold truncate">{pageTitle}</h1>
              <p className="text-xs sm:text-sm text-gray-300 truncate mt-0.5 hidden xs:block sm:block">
                {pageSubtitle}
              </p>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-4 shrink-0">
              <div className="hidden md:block text-right">
                ...
                <p className="text-lg lg:text-2xl font-bold tabular-nums">{currentTime}</p>
              </div>
              <div className="hidden md:block w-px h-10 bg-gray-500" />
