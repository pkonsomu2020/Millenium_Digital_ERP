...
const navItems = [
  ...
  { path: "/dashboard/stock-management", label: "Stock Management", icon: Package },
  { path: "/dashboard/document-vault", label: "Document Vault", icon: FileText },
  { path: "/dashboard/minutes-upload", label: "Minutes Upload", icon: FileCheck },
  { path: "/dashboard/leave-requests", label: "Leave Requests", icon: Users },
...
export function DashboardLayout() {
  ...
  const getPageContext = (path: string) => {
    switch (path) {
      case "/dashboard": return { title: "Dashboard", subtitle: "Welcome to Millennium Digital Admin System" };
      case "/dashboard/stock-management": return { title: "Stock Management", subtitle: "Track and manage office inventory" };
      case "/dashboard/document-vault": return { title: "Document Vault", subtitle: "Manage and secure your digital documents" };
      case "/dashboard/minutes-upload": return { title: "Minutes Upload", subtitle: "Upload and manage meeting minutes" };
      case "/dashboard/leave-requests": return { title: "Leave Requests", subtitle: "Manage employee leave and absences" };
      case "/dashboard/meetings": return { title: "Meetings", subtitle: "Schedule and manage company meetings" };
      default: return { title: "Millennium DAS", subtitle: "System Panel" };
    }
  };
    ...
    <div className="flex h-screen bg-white dark:bg-[#1F2937] overflow-hidden">
      ...
      <main className="flex-1 overflow-auto bg-gray-50 dark:bg-[#111827] w-full flex flex-col">
        ...
        <div className="lg:hidden sticky top-0 z-30 bg-[#374151] text-white p-4 flex items-center justify-between shadow-md">
          ...
          <h1 className="text-lg font-bold">Millennium DAS</h1>
                   ...
                   <DropdownMenu>
                     ...
                     <DropdownMenuContent align="end" className="w-56 mt-2 dark:bg-gray-800 dark:border-gray-700">
                       ...
                       <DropdownMenuItem
                         ...
                         onClick={() => { sessionStorage.removeItem("auth_admin"); sessionStorage.removeItem("auth_user"); window.location.href = "http://localhost:5173/"; }}
                       >
