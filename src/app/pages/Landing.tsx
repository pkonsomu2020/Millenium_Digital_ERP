...
const roles = [
  {
    icon: ShieldCheck, role: "Admin", color: "text-[#E76F51]",
    border: "border-[#E76F51]/30 hover:border-[#E76F51]/60",
    bg: "bg-gradient-to-br from-[#E76F51]/8 to-[#E76F51]/3",
    iconBg: "bg-[#E76F51]/10 border-[#E76F51]/20",
    btnClass: "bg-[#E76F51] hover:bg-[#D0593B]",
    href: "/login/admin",
...
function DashboardMockup() {
  return (
    <div className="relative w-full max-w-2xl mx-auto">
      {/* Glow behind mockup */}
      <div className="absolute inset-0 bg-[#E76F51]/20 blur-3xl rounded-full scale-75 -z-10" />
      <div className="rounded-2xl border border-white/10 bg-gray-900/80 backdrop-blur shadow-2xl overflow-hidden">
        ...
        <div className="flex h-52 sm:h-64">
          ...
          <div className="w-14 sm:w-20 bg-gray-800/60 border-r border-white/5 flex flex-col items-center py-4 gap-3">
            {[...Array(5)].map((_, i) => (
              <div key={i} className={`w-8 h-8 rounded-lg ${i === 0 ? "bg-[#E76F51]/80" : "bg-white/5"}`} />
            ))}
          </div>
          {/* Main area */}
          <div className="flex-1 p-4 space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              {[["#E76F51", "12"], ["#3b82f6", "4"], ["#10b981", "98%"]].map(([color, val], i) => (
            ...
            <div className="rounded-lg bg-white/5 border border-white/5 p-3 flex items-end gap-1 h-20">
              {[40, 65, 45, 80, 55, 90, 70, 85, 60, 75].map((h, i) => (
                <div key={i} className="flex-1 rounded-sm" style={{ height: `${h}%`, background: i === 7 ? "#E76F51" : "rgba(255,255,255,0.15)" }} />
              ))}
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-white dark:bg-[#0a0d14] text-gray-900 dark:text-white flex flex-col transition-colors duration-200">
        ...
        <div className="max-w-6xl mx-auto px-6 py-3.5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden dark:flex items-center gap-2.5">
              <img src="/Millenium_logo_white-removebg-preview.png" alt="Millenium" className="h-8 object-contain" />
              <div className="w-px h-6 bg-gray-700" />
              <img src="/afosi_logo_white.png" alt="AFOSI" className="h-7 object-contain" />
            </div>
            {/* Light Mode Logos */}
            <div className="flex dark:hidden items-center gap-2.5">
              <img src="/Millenum_logo_black-removebg-preview.png" alt="Millenium" className="h-8 object-contain" />
              <div className="w-px h-6 bg-gray-300" />
              <img src="/afosi_logo.png" alt="AFOSI" className="h-7 object-contain" />
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <Link to="/login/hr" className="text-sm bg-[#E76F51] hover:bg-[#D0593B] text-white px-4 py-2 rounded-lg transition-colors font-medium shadow-sm shadow-[#E76F51]/30">
              HR Login
            </Link>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[900px] h-[600px] bg-[#E76F51]/8 dark:bg-[#E76F51]/12 rounded-full blur-[140px]" />
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-16">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight mb-5 leading-[1.08]">
                One platform.<br />
                <span className="text-[#E76F51]">Every</span> operation.
              </h1>
          ...
          <div className="flex justify-center mt-16">
            <button
              ...
              className="flex flex-col items-center gap-1 text-gray-400 dark:text-gray-600 hover:text-[#E76F51] dark:hover:text-[#E76F51] transition-colors"
      ...
      <section id="features" className="max-w-6xl mx-auto px-6 py-24">
        <div className="text-center mb-14">
          <p className="text-xs text-[#E76F51] font-semibold uppercase tracking-widest mb-3">What's inside</p>
      ...
      <section className="bg-gray-50 dark:bg-white/2 border-y border-gray-200 dark:border-white/5 py-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            <p className="text-xs text-[#E76F51] font-semibold uppercase tracking-widest mb-3">How it works</p>
            ...
            {steps.map((s, i) => {
              ...
              return (
                <div key={s.step} className="relative flex flex-col items-center text-center p-6 rounded-2xl bg-white dark:bg-white/3 border border-gray-200 dark:border-white/8 shadow-sm">
                  ...
                  <div className="w-14 h-14 rounded-2xl bg-[#E76F51]/10 border border-[#E76F51]/20 flex items-center justify-center mb-4">
                    <Icon className="w-6 h-6 text-[#E76F51]" />
                  </div>
                  <span className="text-xs font-bold text-[#E76F51] tracking-widest mb-2">{s.step}</span>
      ...
      <section className="bg-gray-50 dark:bg-white/2 border-t border-gray-200 dark:border-white/5 py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-10">
            <p className="text-xs text-[#E76F51] font-semibold uppercase tracking-widest mb-3">Built with</p>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <div key={label} className="flex items-center gap-2 bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-full px-5 py-2.5 text-sm text-gray-600 dark:text-gray-300 shadow-sm hover:border-[#E76F51]/40 transition-colors">
        ...
        <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3 opacity-60">
            <div className="hidden dark:flex items-center gap-2">
              <img src="/Millenium_logo_white-removebg-preview.png" alt="Millenium" className="h-6 object-contain" />
              <div className="w-px h-4 bg-gray-600" />
              <img src="/afosi_logo_white.png" alt="AFOSI" className="h-5 object-contain" />
            </div>
            <div className="flex dark:hidden items-center gap-2">
              <img src="/Millenum_logo_black-removebg-preview.png" alt="Millenium" className="h-6 object-contain" />
              <div className="w-px h-4 bg-gray-400" />
              <img src="/afosi_logo.png" alt="AFOSI" className="h-5 object-contain" />
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 text-xs text-gray-400 dark:text-gray-600">
            <Link to="/login/admin" className="hover:text-[#E76F51] transition-colors">Admin</Link>
            <Link to="/login/hr" className="hover:text-[#E76F51] transition-colors">HR</Link>
          </div>
        </div>
      </footer>
