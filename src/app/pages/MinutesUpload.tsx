...
export function MinutesUpload() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      uploadFormData.append("meeting_date", formData.meeting_date);
      uploadFormData.append("meeting_title", formData.meeting_title);
      uploadFormData.append("uploaded_by", formData.uploaded_by);
      uploadFormData.append("notes", formData.notes);

      await api.uploadMinutes(uploadFormData);
  ...
  const handleDelete = async (id: string, title: string) => {
    if (!confirm(`Are you sure you want to delete minutes for "${title}"?`)) return;
    ...
    <div className="p-4 sm:p-6 lg:p-8 pt-4 sm:pt-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Upload and manage meeting minutes for Millenium Solutions
        </p>
      </div>
